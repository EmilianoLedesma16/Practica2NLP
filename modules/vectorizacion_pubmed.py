...
vectorizador_binario_unigramas = CountVectorizer(binary=True, ngram_range=(1, 1))

# Crear un vectorizador TF (Term Frequency)
vectorizador_tf_unigramas = CountVectorizer(ngram_range=(1, 1))

# Crear un vectorizador TF-IDF
vectorizador_tfidf_unigramas = TfidfVectorizer(ngram_range=(1, 1))

# ------------------------------------------------------------
# Vectorización usando bigramas

# Crear un vectorizador binario
vectorizador_binario_bigramas = CountVectorizer(binary=True, ngram_range=(2, 2))

# Crear un vectorizador TF (Term Frequency)
vectorizador_tf_bigramas = CountVectorizer(ngram_range=(2, 2))

# Crear un vectorizador TF-IDF
vectorizador_tfidf_bigramas = TfidfVectorizer(ngram_range=(2, 2))
...
nombre_archivo = {
    'binario_uni': os.path.join(ruta_matrices, 'pubmed_vector_binaria_uni.pkl'),
    'tf_uni': os.path.join(ruta_matrices, 'pubmed_vector_tf_uni.pkl'),
    'tfidf_uni': os.path.join(ruta_matrices, 'pubmed_vector_tfidf_uni.pkl'),
    'binario_bi': os.path.join(ruta_matrices, 'pubmed_vector_binaria_bi.pkl'),
    'tf_bi': os.path.join(ruta_matrices, 'pubmed_vector_tf_bi.pkl'),
    'tfidf_bi': os.path.join(ruta_matrices, 'pubmed_vector_tfidf_bi.pkl'),
    'binario_uni_vect' : os.path.join(ruta_vectores, 'pubmed_vector_binaria_uni_vect.pkl'),
    'tf_uni_vect' : os.path.join(ruta_vectores, 'pubmed_vector_tf_uni_vect.pkl'),
    'tfidf_uni_vect' : os.path.join(ruta_vectores, 'pubmed_vector_tfidf_uni_vect.pkl'),
    'binario_bi_vect' : os.path.join(ruta_vectores, 'pubmed_vector_binaria_bi_vect.pkl'),
    'tf_bi_vect' : os.path.join(ruta_vectores, 'pubmed_vector_tf_bi_vect.pkl'),
    'tfidf_bi_vect' : os.path.join(ruta_vectores, 'pubmed_vector_tfidf_bi_vect.pkl')
}
